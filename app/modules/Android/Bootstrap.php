<?php
class Android_Bootstrap extends Zend_Application_Module_Bootstrap
{
    protected function _initModulePath(){
        $autoloader = new Zend_Application_Module_Autoloader(
            array(
                'basePath' => APPLICATION_PATH.'/modules/Android',
                'namespace' => 'Android_',
                'resourceTypes' => array(
                    'Controller' => array(
                        'path' => 'Controller/',
    ...
    protected function _initModuleRouter(){
		...
		$config = new Zend_Config_Ini(APPLICATION_PATH.'/modules/Android/config/route.ini');
